...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-hijau-blue-dark to-hijau-blue text-white pt-12 md:pt-16 pb-8">
      <div className="container-custom">
          ...
          <div className="space-y-5">
            ...
            <div className="flex space-x-3 md:space-x-4">
              <a 
                ...
                className="bg-white/10 hover:bg-hijau-yellow hover:text-hijau-blue p-2.5 rounded-full transition-colors duration-300 transform hover:-translate-y-1"
                aria-label="Facebook"
              >
                <Facebook size={16} />
              </a>
              ...
              {["Home", "About", "Packages", "Gallery", "Contact"].map((item) => (
                <li key={item}>
                  <Link 
                    ...
                    className="text-gray-200 hover:text-hijau-yellow flex items-center transition-all duration-200 hover:translate-x-1 text-sm md:text-base"
                  >
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <ul className="space-y-3 md:space-y-4">
              <li className="flex items-start">
                <div className="bg-hijau-yellow/20 p-1.5 md:p-2 rounded-full mr-2 md:mr-3 mt-0.5">
        ...
        <div className="border-t border-white/10 mt-8 md:mt-12 pt-8 text-center text-gray-300 text-sm">
